...
describe("This tests the generateRandomInt function", () => {
    ...
    it("Returns 1 as a mockedImplementation integer", () => {
        const randInt = jest.spyOn(practiceLib, "generateRandomInt");
        randInt.mockImplementation(() => 1);
    ...
    it("Returns 128 as a mockedImplementation integer", () => {
        const randInt = jest.spyOn(practiceLib, "generateRandomInt");
        randInt.mockImplementation(() => 128);
        const result = practiceLib.generateRandomInt();
...
describe("This tests the generateRandomUnit function", () => {
    ...
    it("Returns bit as a mockedImplementation unit", () => {
        const randUnit = jest.spyOn(practiceLib, "generateRandomUnit");
        randUnit.mockImplementation(() => 'bit');
    ...
    it("Returns TB as a mockedImplementation unit", () => {
        const randUnit = jest.spyOn(practiceLib, "generateRandomUnit");
        randUnit.mockImplementation(() => 'TB');
        const result = practiceLib.generateRandomUnit();
